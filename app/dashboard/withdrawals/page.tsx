...
export default function WithdrawalsPage() {
  return (
    <div className="mx-auto max-w-7xl">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-text-primary md:text-3xl">Withdrawals</h1>
        <p className="mt-1 text-sm text-text-secondary">
          Review and approve withdrawal requests from club funds.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-surface-light/50 px-6 py-20 text-center">
        ...
        <p className="mt-1.5 max-w-sm text-sm text-text-secondary">
          Withdrawals is coming soon. We are actively building this out for the agoroll platform.
        </p>
      </div>
    </div>
  );
